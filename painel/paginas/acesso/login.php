...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="painel/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Manda</b>FOODS</a>
    </div>
    <div class="card-body">
      ...
      <div class="social-auth-links text-center mt-2 mb-3">
        ...
        <a href="#" class="btn btn-block btn-danger">
          <i class="fab fa-google-plus mr-2"></i> Entre usando Google+
        </a>
      </div>
      <!-- /.social-auth-links -->
      ...
      <p class="mb-0">
        <a href="register.html" class="text-center">Registre um novo usuário</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
